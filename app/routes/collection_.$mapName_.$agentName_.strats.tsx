        ...
        >
          <div className="relative">
            ...
            <input
              ...
              autoFocus
              className="block w-full p-3 ps-10 text-neutral-200 uppercase font-['Space_Mono'] placeholder:text-neutral-400 bg-neutral-700 border-b-2 border-neutral-600 outline-none hover:bg-neutral-600 hover:border-neutral-500 focus:bg-neutral-600 focus:border-neutral-500 transition"
            />
          </div>
