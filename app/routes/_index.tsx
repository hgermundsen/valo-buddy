  ...
  return (
    <main className="flex flex-col space-y-32 grow justify-center items-center">
      ...
      <div className="flex flex-col items-center space-y-4">
        <h1 className="text-7xl font-['Space_Mono']">ValoBuddy</h1>
        ...
        <div className="flex space-x-4">
          ...
          <Link
            to="login"
            className="p-5 font-['Space_Mono'] uppercase text-white bg-gradient-to-r from-valored-500 to-neutral-900 from-50% to-50% bg-right-bottom bg-[length:201%_100%] outline-none hover:bg-left-bottom hover:text-neutral-900 focus:bg-valored-400 transition-all duration-[230ms] ease-in-out"
          >
            Log in
          </Link>
        </div>
